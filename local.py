...
def get_all_attributes(data_dir=None):
    ...
    output = []
    for image in images:
        output.append(utils.parse_attributes(
            image['attributes'], image_map[image['image_id']]))
    return output


def get_all_relationships(data_dir=None):
    """
    ...
    output = []
    for image in images:
        output.append(utils.parse_relationships(
            image['relationships'], image_map[image['image_id']]))
    return output
